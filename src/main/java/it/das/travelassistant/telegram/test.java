...
public class test {
    ...
    public static final String TOKEN = "323926730:AAEudfVK_JJWHQ89vFrhVoLh-mHGwm5NZuA";
    public static final String PATH = "sendmessage";


    /// Fields of Send Message
    public static final String CHATID_FIELD = "301878958";
    private static Integer chatId; ///< Unique identifier for the message recepient — User or GroupChat id
    public static final String TEXT_FIELD = "prova invio notifica";
