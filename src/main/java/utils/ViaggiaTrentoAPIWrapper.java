...
public class ViaggiaTrentoAPIWrapper {
	...
	public ArrayList <TravelViaggiaTrento> getViaggiaTrentoRoutes(String coordinatesFrom, String coordinatesTo) {
		 ...
		 String result = callURL("https://dev.smartcommunitylab.it/smart-planner2/trentino/rest/plan?from="+coordinatesFrom+"&to="+coordinatesTo+"&date="+date+"&departureTime="+hour+"&transportType=TRANSIT&routeType=fastest&numOfItn=3");
