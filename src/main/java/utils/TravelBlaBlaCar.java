    ...
    public static Comparator <TravelBlaBlaCar> dateHourComparator = new Comparator<TravelBlaBlaCar>() {
        ...
        public int compare(TravelBlaBlaCar t1, TravelBlaBlaCar t2) {
            ...
            if (value1 == 0) {
                ...
                if (value2 == 0) {
                	int value3 = t1.dateHour.substring(6, 10).compareTo(t2.dateHour.substring(6, 10));
                	if(value3 == 0) {
                		int value4 = t1.dateHour.substring(11, 13).compareTo(t2.dateHour.substring(11, 13));
                		if(value4 == 0) {
                			return t1.dateHour.substring(14, 16).compareTo(t2.dateHour.substring(14, 16));
                		}else {
                			return value4;
                		}
                	}else {
